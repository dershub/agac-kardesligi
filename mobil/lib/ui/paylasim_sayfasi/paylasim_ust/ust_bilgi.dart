    ...
    return Center(
      child: Row(
        ...
        children: [
          ...
          bilgiContainer(context, fidanSayi, "fidan", ResimYollari.bitkiSeverResim ),
        ]
      ),
    );
  }
        ...
        children: [
         Expanded(flex: 2, child: Padding(
           ...
           child: RichText(
             text: TextSpan(
               text: "Bugün ",
               style: TextStyle(color: Renk.ustBilgiYesilYazi, fontWeight: FontWeight.bold),
               children: <TextSpan>[
                 TextSpan(text: "$sayi", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
